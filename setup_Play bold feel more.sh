...
# Параметры
BUNDLE_ID="com.playboldmore.feel"
APPLE_ID="6752771938"
REMOTE_URL="git@github.com:sdeslvm/Play-bold-feel-more.git"
PROJECT_NAME="Play bold feel more"
SCHEME_NAME="Play bold feel more"
