...
final class PlayBoldBaseWebViewController: UIViewController, WKScriptMessageHandler {
    ...
    private let loader: PlayBoldWebLoader
    private let coordinator: PlayBoldWebCoordinator
    ...
    init(
        ...
        loader: PlayBoldWebLoader,
        coordinator: PlayBoldWebCoordinator,
    ...
    override func viewDidLoad() {
        ...
        PlayBoldOrientationManager.shared.updateAllowedOrientations(defaultOrientations)
    ...
    private func unlockOrientationIfNeeded() {
        ...
        PlayBoldOrientationManager.shared.updateAllowedOrientations(.all)
    }
...
private extension PlayBoldBaseWebViewController {
